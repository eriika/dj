...
public class EmpresaJ {
    ...
    public void playJuana() {
        ...
        //productos.add = new Producto(01, 20, "Grasa",3,6,9);
    ...
    public class Producto {
        ...
        public Producto(Integer idproducto, Integer descriprecio, String clasificacion,
                Integer cantexist, Integer existmin, Integer existmax) {
            this.idproducto = idproducto;
            this.descriprecio = descriprecio;
            this.clasificacion = clasificacion;
            this.cantexist = cantexist;
